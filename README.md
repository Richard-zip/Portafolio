...
- **Astro:** Framework web moderno para generación de sitios estáticos (SSG) rápidos y ligeros.
- **Tailwind CSS:** Framework de utilidades para un diseño dark técnico y responsivo.
- **TypeScript:** Tipado estático en la lógica y configuración de componentes.
- **MDX:** Formato enriquecido para redactar y estructurar los casos de estudio.
- **Zod & Content Layer:** Validación estricta de datos y metadatos para las colecciones de proyectos.
